...
public class DataGenerator implements CommandLineRunner {
    ...
    RoleService roleService; // To @AutoWired with interface, but @Component in the implementation
    UserService userService; // To @AutoWired with interface, but @Component in the implementation
    ProjectService projectService; // To @AutoWired with interface, but @Component in the implementation
    TaskService taskService; // To @AutoWired with interface, but @Component in the implementation
